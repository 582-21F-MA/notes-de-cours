...
lorsque appelée. La fonction `console.log`, par exemple, ne retourne pas
de valeur :
...
Comme vous pouvez voir, `square` et `square(2)` ont des valeurs
...
> être documentées, mais du bon code nécessite peu de commentaires.
