...
[MDN Web Docs] est la source de documentation principale pour le langage
JavaScript. Elle comprend des [tutoriels pour débutant·es], des [guides]
et du [matériel de référence]. [The Modern JavaScript Tutorial] est
également une excellente ressource, tout comme le livre
[JavaScript: The Definitive Guide] de David Flanagan. Nous recommandons
d'éviter W3Schools, car il contient des informations erronées et
encourage de mauvaises pratiques.

[MDN Web Docs]: https://developer.mozilla.org/en-US/
[tutoriels pour débutant·es]: https://developer.mozilla.org/en-US/docs/Web/JavaScript#beginners_tutorials
[guides]: https://developer.mozilla.org/en-US/docs/Web/JavaScript#javascript_guides
[matériel de référence]: https://developer.mozilla.org/en-US/docs/Web/JavaScript#reference
